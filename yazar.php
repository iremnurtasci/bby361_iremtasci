...
<meta name="theme-color" content="#563d7c">
  ...
  <div class="collapse navbar-collapse" id="navbarCollapse">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item">
        <a class="nav-link" href="eser_islemleri.php">Eser İşlemleri</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="yazar.php">Yazar İşlemleri</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="eserleri_listele.php">Eserleri Listele</a>
      </li>
    </ul>
...
echo("<table border=1 width=80%>");
    ...
    echo("<td><b>Yazar Doğum Tarihi</b></td>");
    echo("<td><b>Yazar Cinsiyet</b></td>");
    echo("<td><b>Yazar URL</b></td>");
    echo("<td><b>Yazar E-posta</b></td>");
...
while($satir = mysqli_fetch_assoc($sorgu)){
    echo("<tr>");
    echo("<td>".$satir["yazarID"]."</td>");
    echo("<td>".$satir["yazarAdi"]."</td>");
    echo("<td>".$satir["yazarSoyadi"]."</td>");
    echo("<td>".$satir["yazarDogumTarihi"]."</td>");
    echo("<td>".$satir["yazarCinsiyet"]."</td>");
    echo("<td>".$satir["yazarURL"]."</td>");
    echo("<td>".$satir["yazarEposta"]."</td>");
    echo("<td><a href='guncellenecek.php?yazarID=".$satir["yazarID"]."'>Güncelle</a></td>");
    echo("<td><a href='sil.php?yazarID=".$satir["yazarID"]."'>Sil</a></td>");
    echo("</tr>");
            }
echo("</table>");
?>

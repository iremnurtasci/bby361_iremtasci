...
<html lang="en" class="h-100">
  <head>
    ...
    <title>BBY361 Yazarları Listele</title>
...
<main class="flex-shrink-0">
  <div class="container">
    <h1 class="mt-5">Yazarları Listele</h1>
        <p class="lead">Bu sayfada veri tabanının yazar tablosunda yer alan kayıtların tamamı listelenmektedir.</p>
    <h2>Yazar Kayıtları</h2>
      <p><?php echo("Toplam kayıt sayısı: ".$toplam);?></p>
      <p>
          <?php
          while($satir = mysqli_fetch_assoc($sorgu)){
              printf($satir["yazarAdi"]." ".$satir["yazarSoyadi"]."</br>");
          }
          ?>
      </p>
  </div>
